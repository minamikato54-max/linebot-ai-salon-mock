...
![管理画面のホーム画面。FAQ・メニュー・会話ログ・お知らせ配信の4つのボタンが並んでいる](./images/owner-admin-home.jpg)
...
![お知らせ配信の確認画面。入力内容のプレビューと「送信する」「内容を直す」ボタンが表示されている](./images/owner-broadcast-confirm.jpg)
